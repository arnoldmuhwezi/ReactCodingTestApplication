...
namespace CodingTestApplication.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BranchID,BranchName,Location,CreationDate")] Branches branches)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BranchID,BranchName,Location,CreationDate")] Branches branches)
        {
            if (ModelState.IsValid)
            {
